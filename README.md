...
I started to realise though that I wasn't using a lot of the features of Phaser and they were adding to its ~800KB minified file size (sorry Phaser, I originally said 800KB which isn't too bad considering the features but not ideal if you can reduce it. I also found there was a limit of how far I could realistically fine tune it to be how I wanted it, especially since I found it doesn't really allow you to change the resolution the canvas is rendered at (it only allows you to upscale it as far as I know).
