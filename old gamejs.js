...
GameJS = {
    "init": function(gameJSON) {
        ...
        */
        ...
        game.internal.collision = {
            "tick": function(game) {
                var length = Object.keys(game.internal.collision.qtree.index.rectangles).length
                var i = 1
                while (i < length) {
                    game.internal.collision.qtree.methods.processRectangle(game, i)
                    i++
                }
                ...
                */
                ...
                game.internal.collision.qtree.rectsToSplit = [] // TODO
                var i = 0
                for (i in game.internal.collision.qtree.rectsToSplit) {
                    ...
                    //rectangle.objectData = newObjectData // TMP TODO
                }
            ...
            "qtree": {
                ...
                "methods": {
                    ...
                    "removeObject": function(id, game, dataIndex) {
                        ...
                        game.internal.collision.qtree.index.rectangles[id].objectData[dataIndex] = [null, game.internal.collision.qtree.index.rectangles[id].objectData[dataIndex]]
                        if (game.internal.collision.qtree.index.rectangles[id].objects == 0) {
                            //console.log(game.internal.collision.qtree.index.rectangles[id])
                        }
                    ...
                    "processRectangle": function(game, id) {
                        var dataIDs = []

                        var rectangle = game.internal.collision.qtree.index.rectangles[id]
                    ...
                    "addObject": function(object, game, centred) {
                        ...
                        */
                        ...
                        for (i in ids) {
                            ...
                            rectangle.objects++
                            if (object.cloneID == 19) {
                                console.log(ids)
                                console.log(JSON.parse(JSON.stringify(rectangle.objectData)))
                            }
                            rectangle.objectData[Object.keys(rectangle.objectData).length] = object
                            if (object.cloneID == 19) {
                                console.log(JSON.parse(JSON.stringify(rectangle.objectData)), "af")
                            }
                            game.internal.collision.qtree.methods.processRectangle(game, ids[i])
    ...
    "internal": {
        ...
        "debugOn": false,
        "debug": function(data) {
            if (GameJS.internal.debugOn) {
                GameJS.internal.debugLog[GameJS.internal.debugLog.length] = data
            }
        }
    },
    "methods": {
                ...
                if (GameJS.config.flags.useQTrees) {
                    ...
                    for (i in me.internal.collision.qtree.IDs) {
                        ...
                        while (objects < rectangle.objects && c < Object.keys(rectangle.objectData).length) {
                            if (testing.includes(JSON.stringify(rectangle.objectData[c]))) { // TODO
                                console.log("Duplicate")
                            }
                            testing[testing.length] = JSON.stringify(rectangle.objectData[c]) // TODO
                            ...
                            */
                            ...
                            if (GameJS.internal.collision.methods.AABB({
                                ...
                                console.log(loops, "early")
                                return true
                            }
                            c++
                        }
                        if (c >= Object.keys(rectangle.objectData).length) {
                            if (Object.values(rectangle.objectData).includes("null")) {
                                debugger
                            }
